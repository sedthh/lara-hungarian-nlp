...
def disallow():
	return {
		"profanity"			: [{"stem":"(fel|le|meg|rá|ki|be|oda|össze|bele|hozzá)?bas*z+d?\s?(at)?(hat)?(us|a[dk]?|á[kl]|[aá]?t[aáo][lkm]?|ott|ni|n[aá]n?[dlkm]?|va|meg)?","wordclass":"regex","without":[{"stem":"megye"}]},{"stem":"((l[oó]|agy)?fasz|fas+z+op[oó]|geci\w*|kurv[aá]|(be)?fos|(be)?szar|buzi|köcsög|pin[aá]|pics[aá]|p[oö]cs|p[eé]nisz)([oö]?k)?r?[aáeo]?(\w{1,2}[aeoöőu][nklt]*)?(n[ae]k)?","wordclass":"regex"},{"stem":"((mother)?f\s?u\s?c\s?k|shit(ass)?|bitch|pussy|cunt|fag(g[eo]t)?|penis|blowjob|butt(plug|head)?|ass|arse|homo|gay|dyke|cock)(e?s|ing|er)?","wordclass":"regex"}],
		"racism"				: [{"stem":"(fek[aá]|nig+(er|a)|n[aá]ci|cig[oó]|cig[aá]n+y|dzsip[oó]|zsidr?[ó])[aáeégklnmstv]*","wordclass":"regex"}],
		"sexual"				: [{"stem":"(sz?ex|an[aá]l|vagina|p[eé]nisz?|creampie|cum|sperma?|fuck|homo(kos|sexu[aá]l(is)?)?|milf|bisexual|gay|dild[oó]|vibr[aá]tor|fellatio|blow\s?job|whore|geci|pussy|pics[aá]|pin[aá]|fasz|piss|boner|xxx+)[aáeéioöőuüdgklmnrstvz]*","wordclass":"regex"}],
		"unplesant"		: [{"stem":"AIDS","wordclass":"noun"},{"stem":"HIV","ignorecase":False},{"stem":"Hitler","wordclass":"noun"},{"stem":"(Sz?t[aá]lin|Lenin)\w*","wordclass":"regex"},{"stem":"pedof[ií]l(i[aá])?[aokltv]*","wordclass":"regex"}],
	}