...
def cocktail():
	return {
		...
		"timer_add"			: [{"stem":"([aá]l+[ií](ts|c+s+)([aá]?[ld])?|csin[aá]lj([aá]l)?|rakj([aá]l)?|hozz\sl[eé]tre|vegy[eé]l\sfel)(\sbe)?(\segy|\saz?)\s(id[oöő]z[ií]t([oöő]|[eé]s)t|riaszt([aá]s|[oó])t|cs[oöe]ng([oöő]|et[eé]s)t|alarmo?t|[eé]breszt\w+)","wordclass":"regex"}],
