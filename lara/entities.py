...
def smalltalk():
	return {
		...
		"about_software": [{"stem":"(hogy(hogy|an)?|mit[oöő]l).+?(m[uüű]k[oö]dsz|(tudsz |vagy k[eé]pes )?(meg)?[eé]rte(sz|d|ni)\,? (meg )?(hogy )?(a?mit mond(ok|tam)|a?mit [ií]r(ok|tam)|engem))","wordclass":"regex"},{"stem":"mi(jen|lyen|en|\s?f[eé]le|\s?fajta)\sfekete\s?m[aá]gia","wordclass":"regex"}],
...
def cocktail():
	return {
		...
		"timer_add"		: [{"stem":"(id[oöő]z[ií]t([oöő]|[eé]s)t|riaszt([aá]s|[oó])t|cs[oöe]ng([oöő]|et[eé]s)t|alarmo?t|[eé]bres+z\w+)","wordclass":"regex","with":[{"stem":"([aá]l+[ií](ts|c+s+)([aáo]?[ldn]?)?|csin[aá]lj([aáo][dln]?)?|rakj([aáo][dln]?)?|hozz([aáo][dln]?)?\sl[eé]tre|v[eé]gy([eé][dln]?)|\sfel)(\sbe|\sfel)?","wordclass":"regex"}]},{"stem":"sz[oó]l?j+([aáo][dln])?\s?(r[aá]m\s|nekem\s)?.+?(m[uú]lva|bel[uü]l)","wordclass":"regex"},{"stem":"kell\.+?kel[nj][ei]\w*","wordclass":"regex","without":[{"stem":"mikor"},{"stem":"hánykor"}]}],
		"timer_remove"	: [{"stem":"(id[oöő]z[ií]t([oöő]|[eé]s)t|riaszt([aá]s|[oó])t|cs[oöe]ng([oöő]|et[eé]s)t|alarmo?t|[eé]bres+z\w+)","wordclass":"regex","with":[{"stem":"([aá]l+[ií](ts|c+s+)([aáo]?[ldn]?)?\sle|kapcsol\w+\s?(m[aá]r\s)?(ki|le)|t[oö]r[oö]l\w+|off\w*|ki(kapcs\w*)?)","wordclass":"regex"}]}],
