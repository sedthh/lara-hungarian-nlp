...
def commands():
	return {
		"ok"					: [{"stem":"ye","affix":["s","ah","p"]},{"stem":"igen"},{"stem":"aha"},{"stem":"ja","affix":["ja","h"]},{"stem":"ok","affix":["é","s","és","sa","ay","ézd","ézza"],"without":[{"stem":"nem"}]},{"stem":"úgy","without":[{"stem":"nem"}]},{"stem":"így","without":[{"stem":"((m[eé]g)?[ns]em*i?|baj)","wordclass":"regex"}]},{"stem":"jó","wordclass":"adjective","without":[{"stem":"((m[eé]g)?[ns]em*i?|baj)","wordclass":"regex"},{"stem":"(nap\w+|reg+elt|est[eé]t)","wordclass":"regex"}]}],
		"cancel"				: [{"stem":"^([ae]z\s)?(\w+\s)?(nem?|no(pe|ne)?)(\s\w+)?(\s\w+)?$","boundary":False,"without":[{"stem":"jó"},{"stem":"tud","wordclass":"verb"},{"stem":"sikerül","affix":["t"]},{"stem":"haragudj","affix":["on"]},{"stem":"tud","wordclass":"verb"}],"wordclass":"regex"},{"stem":"cancel"},{"stem":"mégse","affix":["m"]},{"stem":"elvetés"},{"stem":"ves[ds]e?\sel","wordclass":"regex"}],
		"next"				: [{"stem":"next"},{"stem":"tovább","without":[{"stem":"((m[eé]g)?[ns]em*i?|baj)","wordclass":"regex"}]},{"stem":"előre","without":[{"stem":"((m[eé]g)?[ns]em*i?|baj)","wordclass":"regex"}]},{"stem":"még","wordclass":"regex","without":[{"stem":"((m[eé]g)?[ns]em*i?|baj)","wordclass":"regex"},{"stem":"egy"},{"stem":"1"},{"stem":"hang\w*","wordclass":"regex"}]},{"stem":"more"},{"stem":"continue"},{"stem":"folyta[st]+(a|[ao]?[dn]|ni|ás)?","wordclass":"regex","without":[{"stem":"((m[eé]g)?[ns]em*i?|baj)","wordclass":"regex"}]},{"stem":"következő","affix":["t","re"]}],
		"back"				: [{"stem":"back"},{"stem":"vissza","affix":["lép","lépés"],"without":[{"stem":"hang\w*","wordclass":"regex"}]},{"stem":"hátra"},{"stem":"előző","wordclass":"noun"}],
...
def disallow():
	return {
		"obscene"			: [{"stem":"(fel|le|meg|rá|ki|be|oda|össze|bele|hozzá)?bas*z+d?\s?(at)?(hat)?(us|a[dk]?|á[kl]|[aá]?t[aáo][lkm]?|ott|ni|n[aá]n?[dlkm]?|va|meg)?","wordclass":"regex","without":[{"stem":"megye"}]},{"stem":"((l[oó]|agy)?fasz|fas+z+op[oó]|geci\w*|kurv[aá]|(be)?fos|(be)?szar|buzi|köcsög|pin[aá]|pics[aá]|p[oö]cs|p[eé]nisz)([oö]?k)?r?[aáeo]?(\w{1,2}[aeoöőu][nklt]*)?(n[ae]k)?","wordclass":"regex"},{"stem":"((mother)?f\s?u\s?c\s?k|shit(ass)?|bitch|pussy|cunt|fag(g[eo]t)?|penis|blowjob|butt(plug|head)?|ass|arse|homo|gay|dyke|cock)(e?s|ing|er)?","wordclass":"regex"}],
		"racist"				: [{"stem":"(fek[aá]|nig+(er|a)|n[aá]ci|cig[oó]|cig[aá]n+y|dzsip[oó]|zsidr?[ó])[aáeégklnmstv]*","wordclass":"regex"}],
		"erotic"				: [{"stem":"(sz?ex|an[aá]l|vagina|p[eé]nisz?|creampie|cum|sperma?|fuck|homo(kos|sexu[aá]l(is)?)?|milf|bisexual|gay|dild[oó]|vibr[aá]tor|fellatio|blow\s?job|whore|geci|pussy|pics[aá]|pin[aá]|fasz|piss|boner|xxx+|hentai|ec+hi|yaoi|loli|shot[aá]|\w*porn[oó]?(film)?)[aáeéioöőuüdgklmnrstvz]*","wordclass":"regex"}],
