...
def smalltalk():
	return {
		...
		"user_love"			: [{"stem":"szeretlek"},{"stem":"szeretsz engem"},{"stem":"tetszek neked"},{"stem":"tetszel nekem","without":[{"stem":"nem"}]},{"stem":"tetszek neked"},{"stem":"szerelmes.+?bel[eé]d","wordclass":"regex"},{"stem":"bel[eé]d.+?szerettem","wordclass":"regex"},{"stem":"tal([aá]lko|i)z+(hat)?(unk|n[aá]nk)","wordclass":"regex"}],
		"user_flirting"		: [{"stem":"mi(lyen)?\s(ruha\s)?van\s?(most\s?)?rajtad","wordclass":"regex"},{"stem":"(meg)?(basz|dug)(unk|n[aá]lak|lak)","wordclass":"regex"},{"stem":"sz?ex(e[lt]\w*)?","wordclass":"regex"},{"stem":"folyt(ogas+d?|s([aá]l)? meg) (a nyakam )?(a\s|egy\s)?(d[oö]gl[oö]tt|halott) macsk[aá]val","wordclass":"regex"}],
		...
		"user_angry"		: [{"stem":"ne\s((h[uú]z+|bas+z|d[uü]h[ií])\w*\s?fel|idege(s[ií]ts|lj([eé]l)?\s?(ki)?))","wordclass":"regex"},{"stem":"(ideges|m[eé]rges|d[uü]h[oö]s)\s(vagyok|voltam)","wordclass":"regex"},{"stem":"haragszom","without":[{"stem":"nem"}]},{"stem":"(mi([eé]r)?t?\s)?nem\s(hall|[eé]rt)([ae]sz|[eo]d)","wordclass":"regex"}],
		"user_forgiving"	: [{"stem":"meg\s?(van\s)?bocs[aá]l?j?t(o(t+a)?[km]|va)","wordclass":"regex"},{"stem":"(nem|dehogy)\sharagszo[km]","wordclass":"regex"}],
		"user_sorry"		: [{"stem":"meg\s?(tud(sz|n[aá]l)\s)?bocs[aá]l?j?ta?(ni|sz|od|t*ot+ad)","wordclass":"regex"},{"stem":"ne haragudj"}],
		...
		"about_age"			: [{"stem":"mennyi idős vagy"},{"stem":"hány éves vagy"},{"stem":"melyik évben születtél"},{"stem":"mikor születtél"},{"stem":"(melyik\s[eé]vben|mikor)\sk[eé]sz([uü]lt[eé]l|[ií]tettek)","wordclass":"regex"},{"stem":"(h[aá]nyadik|mikor\s(van|[uü]nnepled)\s?a?)\ssz[uü]l(et[eé]s|i)napod(at)?","wordclass":"regex"},{"stem":"hány\sévesnek\s.+?\smagad(at)?","wordclass":"regex"}],
