...
def common():
	return {
		...
		"no"					: [{"stem":"nem","without":[{"stem":"megy"},{"stem":"baj"},{"stem":"tud","wordclass":"verb"},{"stem":"ért","wordclass":"verb"}]},{"stem":"ne","without":[{"stem":"haragudj","affix":["on"]}]},{"stem":"soha"},{"stem":"mégse","affix":["m"]},{"stem":"rossz\s(v[aá]lasz|vicc|megold[aá]s)","wordclass":"regex"},{"stem":"nincs rendben"}],
		"hi" 					: [{"stem":"ha?i+","wordclass":"regex"},{"stem":"s+z+i+[aoó](ka|sztok)?","wordclass":"regex"},{"stem":"helló","affix":["ka"]},{"stem":"szer?[bv][au]sz(tok)?","wordclass":"regex"},{"stem":"hali","affix":["hó"]},{"stem":"(sz[eé]p|j[oó])\s?(reggelt|napot|est[eé]t)","wordclass":"regex"},{"stem":"[uü]dv([oö]z[oö]?l+(e[kt])?([eoö]m)?)?","wordclass":"regex"},{"stem":"örvendek"}],
		...
		"thx"					: [{"stem":"(ezer\s?)?(k[oö]s+z|k[oösz][oösz][oösz])(i(ke)?|ke|[oö]n[oö]m|[oö]nj[uü]k|[eoö]net(em)?|csi|ent+y[uüű])?(\s?sz[eé]pen)?","wordclass":"regex"},{"stem":"[ht][ht]x"},{"stem":"t(ha|h?e)nks?\s?(you)?","wordclass":"regex"}],
		...
		"sorry"				: [{"stem":"(meg)?bocs(i(ka)?|esz|[aá](nat([aá][eé]rt)?|nat[aáo]t?|ss|sson|j?t(ana)?))?","wordclass":"regex"},{"stem":"elnézés","wordclass":"noun","match_stem":False},{"stem":"sajnál(om|juk)","wordclass":"regex"},{"stem":"s+z*o+r+[iy]+","wordclass":"regex"}],
		...
		"nvm"				: [{"stem":"felejts[ed]n?\sel","wordclass":"regex"},{"stem":"mindegy","without":[{"stem":"hogy"},{"stem":"nem"}]},{"stem":"nem fontos"},{"stem":"hagy(jad?|d)","wordclass":"regex","with":[{"stem":"jól","affix":["van"]},{"stem":"á"},{"stem":"mindegy"},{"stem":"inkább"}]},{"stem":"ne\s(is\s)?(foglalkoz+(on|[aá]l)?|t[oö]r[oöő]dj([oö]n|[eé]l)?)\s(vel(e|[uü]k)|[ae][vz]+[ae]l)","wordclass":"regex"},{"stem":"hagy\w+\sfigyelmen\sk[ií]v[uü]l","wordclass":"regex","without":[{"stem":"ne"}]}],
		...
		"command"		: [{"stem":"(csin[aá]l(jad?|d)|(keres|mutas|mond)[aedjos]+n?|néz[nz]?[eé]?[dl]|akaro[km]|utas[ií]t\w{1,})","wordclass":"regex"},{"stem":"haj[cts]+(a|[aá]?[ld])\sv[eé]gre","wordclass":"regex"}],
...
def commands():
	return {
		"ok"					: [{"stem":"ye","affix":["s","ah","p"]},{"stem":"igen"},{"stem":"aha"},{"stem":"ja","affix":["ja","h"]},{"stem":"ok","affix":["é","s","és","sa","ay","ézd","ézza"],"without":[{"stem":"nem"}]},{"stem":"úgy","without":[{"stem":"nem"}]},{"stem":"így","without":[{"stem":"((m[eé]g)?[ns]em*i?|baj)","wordclass":"regex"}]},{"stem":"jó","wordclass":"adjective","max_words":4,"without":[{"stem":"((m[eé]g)?[ns]em*i?|baj)","wordclass":"regex"},{"stem":"(nap\w+|reg+elt|est[eé]t)","wordclass":"regex"}]}],
		"cancel"				: [{"stem":"^([ae]z\s)?(\w+\s)?(nem?|no(pe|ne)?)(\s\w+)?(\s\w+)?$","boundary":False,"without":[{"stem":"jó"},{"stem":"tud","wordclass":"verb"},{"stem":"sikerül","affix":["t"]},{"stem":"haragudj","affix":["on"]},{"stem":"tud","wordclass":"verb"}],"wordclass":"regex"},{"stem":"cancel"},{"stem":"mégse","affix":["m"],"max_words":4},{"stem":"elvetés"},{"stem":"ves[ds]e?\sel","wordclass":"regex"}],
		"next"				: [{"stem":"next"},{"stem":"tovább","max_words":5,"without":[{"stem":"((m[eé]g)?[ns]em*i?|baj)","wordclass":"regex"}]},{"stem":"előre","max_words":5,"without":[{"stem":"((m[eé]g)?[ns]em*i?|baj)","wordclass":"regex"}]},{"stem":"még","max_words":4,"wordclass":"regex","without":[{"stem":"((m[eé]g)?[ns]em*i?|baj)","wordclass":"regex"},{"stem":"egy"},{"stem":"1"},{"stem":"hang\w*","wordclass":"regex"}]},{"stem":"more"},{"stem":"continue"},{"stem":"folyta[st]+(a|[ao]?[dn]|ni|ás)?","wordclass":"regex","without":[{"stem":"((m[eé]g)?[ns]em*i?|baj)","wordclass":"regex"}]},{"stem":"következő","affix":["t","re"]}],
		"back"				: [{"stem":"back"},{"stem":"vissza","max_words":5,"affix":["lép","lépés"],"without":[{"stem":"hang\w*","wordclass":"regex"}]},{"stem":"hátra","max_words":4},{"stem":"előző","wordclass":"noun","max_words":5}],
		"save"				: [{"stem":"save"},{"stem":"ment","wordclass":"verb"},{"stem":"mentés","wordclass":"noun"}],
		"open"				: [{"stem":"open","without":[{"stem":"menü","wordclass":"noun"}]},{"stem":"nyit","wordclass":"verb","without":[{"stem":"menü","wordclass":"noun"}]},{"stem":"nyis","match_stem":False,"wordclass":"verb","without":[{"stem":"menü","wordclass":"noun"}]}],
		"delete"				: [{"stem":"del","affix":["ete"]},{"stem":"töröl","wordclass":"verb"},{"stem":"törlés"},{"stem":"(kuk[aá]|lomt[aá]r)(ba)?","wordclass":"regex"}],
		"exit"					: [{"stem":"(exit|quit)(elj([eé][dln])?)?","wordclass":"regex"},{"stem":"esc","affix":["ape"]},{"stem":"kilép","wordclass":"verb","prefix":[],"affix":["ás"]},{"stem":"bezár","wordclass":"verb","prefix":[],"affix":["ás"]},{"stem":"(l[eé]pj?([eé][dln])?.+?ki|z[aá]r(ja)?d?.+?be)","wordclass":"regex"},{"stem":"(kapcso[lj]\w{1,3}\s?(m[aá]r\s)?(ki|le))|(csuk\w{1,3}\s?(m[aá]r\s)?be)","wordclass":"regex"}],
		"options"			: [{"stem":"options","wordclass":"noun"},{"stem":"settings","wordclass":"noun"},{"stem":"be[aá]l+[ií]t\w*","wordclass":"regex"},{"stem":"[aá]ll[ií]ts.+?be","wordclass":"regex"}],
		"menu"				: [{"stem":"menü","prefix":["main","fő","al","legördülő"],"affix":["pont","elem"],"wordclass":"noun"}],
		...
		"error"				: [{"stem":"error","wordclass":"noun"},{"stem":"hiba","wordclass":"noun"},{"stem":"rossz","wordclass":"adjective","without":[{"stem":"[eé]rzem|kedv(e[dm]?)?|vagyok","wordclass":"regex"}]},{"stem":"nem (siker[uü]lt|j[oó]l?|m[uüű]k[oö]d(ik|[oö]tt)|ment)(\s\w)?(\s\w)?$","wordclass":"regex"},{"stem":"(le|ki|be|meg)fagyott","wordclass":"regex"},{"stem":"nem megy"}],
		...
		"stop"				: [{"stem":"(meg|le)?[aá]l+(j+([aá]l)?|[ií][ct]+(s?a?d|sa|[aá](ni|s)))(\smeg|\sle)?","wordclass":"regex"},{"stem":"stop"},{"stem":"el[eé]g(\sis)?(\sle(sz|gyen))?(\sm[aá]r)?(\smost)?(\sennyi)?","wordclass":"regex"},{"stem":"(kus+(olj([aá]l)?)?|fog(ja)?d\s?be)","wordclass":"regex"},{"stem":"(s+h{2,})|(p+s+z*t+)","wordclass":"regex"}],
		...
		"skip"				: [{"stem":"(kihagy\w+|hag+yj?a?d?\ski|([aá]t|tov[aá]bb)(l[eé]p|ugr[aá])\w*|(ugr[aá]s|ugor\w+|l[eé]p(je)?[dn])\s([aá]t|tov[aá]bb))","wordclass":"regex"},{"stem":"(sz?kip+(el\w*)?|m[aá]sikat)","wordclass":"regex"}],
		...
		"volume_down"	: [{"stem":"((cs[oö]k+en\w+|alacsony\w+|le(j+eb+)?)\s(\w+\s)?hang(er)?[eoöő]?(j[aáeé])?t?|hang(er)?[eoöő]?(j[aáeé])?t?\s(cs[oö]k+en\w+|alacsony\w+|le(j+eb+)?))","wordclass":"regex"},{"stem":"t[uú]l\shangos\w*","wordclass":"regex"},{"stem":"halk[aií]\w+","wordclass":"regex","without":[{"stem":"túl"}]}],
		"mute"				: [{"stem":"n[eé]m[aáií]\w{0,3}","wordclass":"regex","without":[{"stem":"vége"},{"stem":"vissza"},{"stem":"feloldás","affix":["a"]}]},{"stem":"mute","wordclass":"verb","prefix":["le","ki"]},{"stem":"(kus+(ol\w*)?|cs[eoö]nd(ben?|et)?)(\sel|\s?legyen)?","wordclass":"regex"}],
...
def smalltalk():
	return {
		...
		"user_angry_at_you"	: [{"stem":"ne\s((h[uú]z+|bas+z|d[uü]h[ií])\w*\s?fel|idege(s[ií]ts|lj([eé]l)?\s?(ki)?))","wordclass":"regex"},{"stem":"(ideges|m[eé]rges|d[uü]h[oö]s)\s(vagyok|voltam)","wordclass":"regex"},{"stem":"haragszom","without":[{"stem":"nem"}]},{"stem":"(mi([eé]r)?t?\s)?nem\s(hall|[eé]rt)([ae]sz|[eo]d)","wordclass":"regex"},{"stem":"nem?\sbesz[eé]l(j|het(sz)?)\s[ií]gy","wordclass":"regex"},{"stem":"megbántott","affix":["ál"]},{"stem":"ez nem volt szép"}],
		...
		"user_back"		: [{"stem":"(vissza|meg|haza)\s?(is\s)?(j[oö]tt|t?[eé]rt|[eé]rkezt)(em|[uü]nk)","wordclass":"regex"},{"stem":"[io]tt(hon)?\s(is\s)?vagy(ok|unk)","wordclass":"regex"}],
		...
		"about_name"	: [{"stem":"(mond*(ja)?\ski|mi\sa)\s(bece)nev[eé][dt](et)?","wordclass":"regex"},{"stem":"(hogy(an)?|minek)\s(is\s)?(h[ií]v([jn][aá](la)?k|hatom)|nevez+(nek|elek))","wordclass":"regex"},{"stem":"(mi?[eé]rt\s|hogy[\s\-]?hogy\s)(lett\s)?(pont\s)?(ezt?\s(lett\s)?(a\s)?|[ií]gy\s|ilyen\s)(nevez[nt]ek|h[ií]v[nt]ak|neved|nevet\s(kapt[aá][dl]|adt[aá]k))","wordclass":"regex"},{"stem":"mi\sa\s(bece)?neved?","wordclass":"regex","without":[{"stem":"az|[ae]nn[ae]k|amiben?|amelyik\w*","wordclass":"regex"}]}],
		...
		"are_you_hungry": [{"stem":"kérsz","with":[{"stem":"enni"}]},{"stem":"nem vagy éhes"},{"stem":"éhes vagy"},{"stem":"(nem\s)?enn[eé]l?\s(meg\s)?(most\s)?(velem\s)?valamit?","wordclass":"regex"},{"stem":"(nem vagy kaj[aá]s|kaj[aá]s vagy)","wordclass":"regex"}],
		"are_you_thirsty": [{"stem":"kérsz","with":[{"stem":"inni"}]},{"stem":"nem vagy szomjas"},{"stem":"szomjas vagy"},{"stem":"(nem )?i(nn[aá]|szo)l?\s(meg\s)?(most\s)?(velem\s)?valamit?","wordclass":"regex"}],
		...
		"are_you_serious": [{"stem":"(nem?|csak)\s(viccel(sz|j)|mond+(od)?|ideges[ií]ts)","wordclass":"regex"},{"stem":"(ne|csak)?\sviccel(sz|j)","wordclass":"regex"},{"stem":"(komolyan|t[eé]nyleg)\s?([uúií]gy\s|azt\s)?((mond|gondol|[ií]r)(ja|od|tad)|hisz(i|ed)|hitted?)","wordclass":"regex"},{"stem":"biztos(an)?\s(vagy\s)?(\w+\s)?(benne|ebben|mondod|mondja)","wordclass":"regex"},{"stem":"ezt?\s(most\s)?komoly(an)?","wordclass":"regex"}],
		"can_you_hear_me": [{"stem":"(olvassa|hallja|n[eé]zi|van\sitt)(\sezt)?\s(vala|b[aá]r)ki(\sis)?","wordclass":"regex"},{"stem":"(hall(asz|od)|l[aá]t(sz|od)|vesze[ld])\s(engem|a?mit\s(mondok|[ií]rok|k[eé]rdezek))","wordclass":"regex"},{"stem":"valaki\s(hall(ja)?\s|olvassa|figyeli?(\sarra)?)\samit\s(ide\s?|itt\s)?([ií]rok|mondok|k[eé]rdezek)","wordclass":"regex"}],
...
def cocktail():
	return {
		...
		"random_dice"	: [{"stem":"(dob[oó])?kock[aá]\w*","wordclass":"regex","with":[{"stem":"(dob[dj]|gur[ií]ts)([aáo][dln]?)?","wordclass":"regex"},{"stem":"(\d+|oldal[auú]s?)","wordclass":"regex"}],"without":[{"stem":"([eé]rm[eé]|p[eé]nz|fej)\w*","wordclass":"regex"}]},{"stem":"(dob[dj]|gur[ií]ts)([aáo][dln]?)?\.+?(\d+|hat\s?o\w+)","wordclass":"regex","without":[{"stem":"([eé]rm[eé]|p[eé]nz|fej)\w*","wordclass":"regex"}]},{"stem":"dice","with":[{"stem":"roll"},{"stem":"random"}]}],
		"random_card"	: [{"stem":"(h[uú]z+([aáo][dln])?|v[aá]las+z([aáo][dln])?)(\ski)?(\segy|\saz?)?\s(lapot|k[aá]rty[aá](lapo(ka)?)?t)","wordclass":"regex"}],
		"timer_add"		: [{"stem":"(id[oöő]z[ií]t([oöő]|[eé]s)t|riaszt([aá]s|[oó])t|cs[oöe]ng([oöő]|et[eé]s)t|alarm(o?t)?|[eé]bres+z\w*)","wordclass":"regex","with":[{"stem":"([aá]l+[ií](ts|c+s+)([aáo]?[ldn]?)?|csin[aá]lj([aáo][dln]?)?|rakj([aáo][dln]?)?|hozz([aáo][dln]?)?\sl[eé]tre|v[eé]gy([eé][dln]?)|\sfel)(\sbe|\sfel)?","wordclass":"regex"},{"stem":"set|on|enable|start","wordclass":"regex"}]},{"stem":"sz[oó]l?j+([aáo][dln])?\s?(r[aá]m\s|nekem\s)?.+?(m[uú]lva|bel[uü]l)","wordclass":"regex"},{"stem":"kell\.+?kel[nj][ei]\w*","wordclass":"regex","without":[{"stem":"mikor"},{"stem":"hánykor"}]}],
		"timer_remove"	: [{"stem":"(id[oöő]z[ií]t([oöő]|[eé]s)t|riaszt([aá]s|[oó])t|cs[oöe]ng([oöő]|et[eé]s)t|alarm(o?t)?|[eé]bres+z\w*)","wordclass":"regex","with":[{"stem":"([aá]l+[ií](ts|c+s+)([aáo]?[ldn]?)?\sle|kapcsol\w+\s?(m[aá]r\s)?(ki|le)|t[oö]r[oö]l\w+|off\w*|ki(kapcs\w*)?)","wordclass":"regex"},{"stem":"off|disable|delete|remove","wordclass":"regex"}]}],
		"calendar_info"	: [{"stem":"(megbesz[eé]l[eé]st?|me+ting\w*|id[oőö]pont(ok)?|napt[aá]r|[kc]al+end[aá]r|tal[aá]lkoz[oó]|teend[oöő]|esem[eé]ny)\w*","wordclass":"regex","with":[{"stem":"(mi(ke?)?t?\s(van(nak)?|[ií]r\w*)|van(nak)?\s(\w+\s)?m[aá](ra)?|m[aá](i|ra)|valami|mutas(s?a)?d|olvas(s?a)?d)|lek[eé]r\w*|list[aá]\w*|olvas\w*","wordclass":"regex"}]},{"stem":"(mai\s(feladat|program)\w*|(feladat|program)\w*\s(az?\s)?m[aá]i?(ra)?)","wordclass":"regex"}],
		"calendar_add"	: [{"stem":"(megbesz[eé]l[eé]st?|me+ting\w*|id[oőö]pont(ok)?|napt[aá]r|[kc]al+end[aá]r|tal[aá]lkoz[oó]|teend[oöő]|esem[eé]ny)\w*","wordclass":"regex","with":[{"stem":"([ií]r[dj]([aáou][dkln]?)?\s(be|fel|meg)|ve(d+|gy[eéuü][dkln]?)\sfel|ad(j[aáou])?[dkln]?|hozz([aáou][lkdn]?)?\sl[eé]tre)","wordclass":"regex"},{"stem":"(felv[eé][stv]|hozz[aá]\s?ad|[ií]r[aá]s|foglal)\w*","wordclass":"regex"}]}],
		"calendar_remove": [{"stem":"(megbesz[eé]l[eé]st?|me+ting\w*|id[oőö]pont(ok)?|napt[aá]r|[kc]al+end[aá]r|tal[aá]lkoz[oó]|teend[oöő]|esem[eé]ny)\w*","wordclass":"regex","with":[{"stem":"(t[oö]r[oö]l[jd]([eéoöuü][dkln]?)?|ve(d+|gy[eéuü][dkln]?)\s(ki|le)|\w*t[oö]rl[eé]s\w*)","wordclass":"regex"}]}],
		"calendar_modify": [{"stem":"(megbesz[eé]l[eé]st?|me+ting\w*|id[oőö]pont(ok)?|napt[aá]r|[kc]al+end[aá]r|tal[aá]lkoz[oó]|teend[oöő]|esem[eé]ny)\w*","wordclass":"regex","with":[{"stem":"([ií]r[dj]([aáou][dkln]?)?\s[aá]t|te(gy[euü]k?)?d*\s[aá]t|szerkes+z\w+|m[oó]dos[ií][ct]\w+|rak(j[aáou])?[lkdn]?\s[aá]t)|[aá]t[ií]r[aá]s\w*","wordclass":"regex"}]}],
		...
		"joke"				: [{"stem":"vicc","wordclass":"noun","without":[{"stem":"(ez\s(csak\s)?valami|rossz)","wordclass":"regex"}]},{"stem":"vid[ií][ct]s+([aáo][dln])?\s?fel","wordclass":"regex"},{"stem":"nevet+es+([eé][dln])?\s?meg","wordclass":"regex"},{"stem":"felvid[ií]t(hat|a)(sz|n[aá][dl]?)","wordclass":"regex"},{"stem":"valami mókásat"}],
		...
		"zodiac"				: [{"stem":"horosz","affix":["pók","kóp"],"match_stem":False,"wordclass":"noun"},{"stem":"csillagok","affix":["ban"],"with":[{"stem":"ír","wordclass":"verb"},{"stem":"mond","wordclass":"verb"}]},{"stem":"aszcendens","wordclass":"noun"}],
		...
		"music"				: [{"stem":"zene","wordclass":"noun"},{"stem":"(kezdj(\sel)?\s)?(le)?j[aá]ts+z([aáo][dln]?|ani)?(\sle)?\s","wordclass":"regex"},{"stem":"(be)?(tegy[eé][dl]|tehetn[eé][dln]?|tedd|rakj?[aáo]?[dln]?|rakhatn[aá][dl]?)(\sbe)?\s(valamit?\s)?\w[lt]","wordclass":"regex"},{"stem":"j[aá]ts+z\w*\s(le|valamit?)","wordclass":"regex"}],
...
def disallow():
	return {
		"obscene"			: [{"stem":"(fel|le|meg|rá|ki|be|oda|össze|bele|hozzá)?bas*z+d?\s?(at)?(hat)?(us|a[dk]?|á[kl]|[aá]?t[aáo][lkm]?|ott|ni|n[aá]n?[dlkm]?|va|meg)?","wordclass":"regex","without":[{"stem":"megye"}]},{"stem":"((l[oó]|agy)?fasz|fas+z+op[oó]|geci\w*|kurv[aá]([eé]let|an+yj?[aá])?|(be)?fos|ribanc|(be)?szar|buzi|köcsög|pin[aá]|pics[aá]|p[oö]cs|p[eé]nisz)([oö]?k)?r?[aáeo]?(\w{1,2}[aeoöőu][nklt]*)?(n[ae]k)?\b","wordclass":"regex","boundary":False},{"stem":"((mother)?f\s?u\s?c\s?k|shit(ass)?|bitch|pussy|cunt|fag(g[eo]t)?|penis|blowjob|butt(plug|head)?|ass|arse|homo|gay|dyke|cock|dick(pic)?)(e?s|ing|e?r)?","wordclass":"regex"}],
		"racist"				: [{"stem":"(fek[aá]|nig+(er|a)|n[aá]ci|cig[oó]|cig[aá]n+y|gypsy|dzsip[oó]|zsidr?[ó])[aáeégklnmstv]*","wordclass":"regex"}],
		"erotic"				: [{"stem":"(sz?ex|an[aá]l|vagina|p[eé]nisz?|creampie|cum|sperma?|fuck|homo(kos|sexu[aá]l(is)?)?|milf|bisexual|gay|dild[oó]|vibr[aá]tor|fellatio|blow\s?job|whore|geci|pussy|pics[aá]|pin[aá]|fasz|piss|boner|dick(pic)?|xxx+|hentai|catgirl|ec+hi|yaoi|loli|shot[aá]|\w*porn[oó]?(film)?)[aáeéioöőuüdgklmnprstvz]*","wordclass":"regex"}],
		"unpleasant"		: [{"stem":"AIDS","wordclass":"noun"},{"stem":"HIV","ignorecase":False},{"stem":"Hitler","wordclass":"noun"},{"stem":"(Sz?t[aá]lin|Lenin)\w*","wordclass":"regex"},{"stem":"pedof[ií]l(i[aá])?[aokltv]*","wordclass":"regex"},{"stem":"(furry|bestiality|yiffy?)[aáeégklnmstv]*","wordclass":"regex"}],
	}