...
def commands():
	return {
		...
		"cancel"			: [{"stem":"^([ae]z\s)?(\w+\s)?(nem?|no(pe|ne)?)(\s\w+)?(\s\w+)?$","boundary":False,"without":[{"stem":"jó"},{"stem":"tud","wordclass":"verb"},{"stem":"sikerül","affix":["t"]}],"wordclass":"regex"},{"stem":"cancel"},{"stem":"mégse","affix":["m"]},{"stem":"elvetés"},{"stem":"ves[ds]e?\sel","wordclass":"regex"}],
		...
		"back"				: [{"stem":"back"},{"stem":"vissza","affix":["lép","lépés"],"without":[{"stem":"hang(o\w+)?","wordclass":"regex"}]},{"stem":"hátra"}],
		...
		"exit"				: [{"stem":"exit"},{"stem":"quit"},{"stem":"esc","affix":["ape"]},{"stem":"kilép","wordclass":"verb","prefix":[],"affix":["ás"]},{"stem":"bezár","wordclass":"verb","prefix":[],"affix":["ás"]},{"stem":"(l[eé]pj?([eé][dln])?.+?ki|z[aá]r(ja)?d?.+?be)","wordclass":"regex"}],
