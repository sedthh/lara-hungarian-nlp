...
def common():
	return {
		...
		"no"				: [{"stem":"nem","without":[{"stem":"megy"},{"stem":"baj"},{"stem":"tud","wordclass":"verb"}]},{"stem":"ne","without":[{"stem":"haragudj","affix":["on"]}]},{"stem":"soha"},{"stem":"mégse","affix":["m"]},{"stem":"rossz\s(v[aá]lasz|vicc|megold[aá]s)","wordclass":"regex"},{"stem":"nincs rendben"}],
		...
		"nvm"				: [{"stem":"felejts[ed]n?\sel","wordclass":"regex"},{"stem":"mindegy","without":[{"stem":"hogy"},{"stem":"nem"}]},{"stem":"nem fontos"},{"stem":"hagy(jad?|d)","wordclass":"regex","with":[{"stem":"jól","affix":["van"]},{"stem":"á"},{"stem":"mindegy"},{"stem":"inkább"}]},{"stem":"ne\s(is\s)?(foglalkoz+(on|[aá]l)?|t[oö]r[oöő]dj([oö]n|[eé]l)?)\s(vel(e|[uü]k)|[ae][vz]+[ae]l)","wordclass":"regex"}],
...
def commands():
	return {
		...
		"error"				: [{"stem":"error","wordclass":"noun"},{"stem":"hiba","wordclass":"noun"},{"stem":"rossz","wordclass":"adjective","without":[{"stem":"[eé]rzem|kedv(em)?|vagyok","wordclass":"regex"}]},{"stem":"nem (siker[uü]lt|j[oó]l?|m[uüű]k[oö]d(ik|[oö]tt)|ment)(\s\w)?(\s\w)?$","wordclass":"regex"},{"stem":"(le|ki|be|meg)fagyott","wordclass":"regex"},{"stem":"nem megy"}],
		...
		"mute"				: [{"stem":"n[eé]m[aáií]\w{0,3}","wordclass":"regex","without":[{"stem":"vége"},{"stem":"vissza"},{"stem":"feloldás","affix":["a"]}]},{"stem":"mute","wordclass":"verb","prefix":["le","ki"]},{"stem":"kus+(ol\w*)?(\sel|\slegyen)?","wordclass":"regex"}],
...
def smalltalk():
	return {
		...
		"user_back"			: [{"stem":"(vissza|meg|haza)\s?(is\s)?(j[oö]tt|[eé]rt|[eé]rkezt)(em|[uü]nk)","wordclass":"regex"},{"stem":"[io]tt(hon)?\s(is\s)?vagy(ok|unk)","wordclass":"regex"}],
...
def cocktail():
	return {
		...
		"timer_remove"		: [{"stem":"(id[oöő]z[ií]t([oöő]|[eé]s)t|riaszt([aá]s|[oó])t|cs[oöe]ng([oöő]|et[eé]s)t|alarmo?t|[eé]breszt\w+)","wordclass":"regex","with":[{"stem":"([aá]l+[ií](ts|c+s+)([aáo]?[ldn]?)?\sle|kapcsol\w+\s?(m[aá]r\s)?(ki|le)|t[oö]r[oö]l\w+|off\w*|ki(kapcs\w*)?)","wordclass":"regex"}]}],
