...
@pytest.mark.parametrize("entity", [
    "example_chatbot_1","example_chatbot_2","example_chatbot_3","example_chatbot_4","example_chatbot_5","example_chatbot_6","example_huszt","example_news","example_wiki_intents","example_stemmer","example_tweet","example_entities"
])
